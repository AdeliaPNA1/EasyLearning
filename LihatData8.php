            ...
            <div class="card-body"> 
                <table class="table table-bordered" width="60%">
                    ...
                    foreach($data_materi as $row)
                    {
                        ...
                        echo "<td><a class='btn btn-info' href='EditData8.php?id_materi=".$row['id_materi']."'>Update</a>
                                <a class='btn btn-danger' href='LihatData8.php?hapusMateri=".$row['id_materi']."'>Hapus</a>
                                <a class='btn btn-info' href='LihatDataUmum2.php'?id_materi=".$row['id_materi']."'>Lihat</td>";
                        echo "</tr>";
                        $no++;
                    }
                    ?>
