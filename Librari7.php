...
class Library
{
    ...
    {
        $data = $this->db->prepare('INSERT INTO teknologiinformasi (namaMateri,kategori,jenisPembelajaran) VALUES (?, ?, ?)');
    ...
    {
        $query = $this->db->prepare("SELECT * FROM teknologiinformasi");
        $query->execute();
        $data = $query->fetchAll();
        return $data;
    }
    ...
    public function get_by_id($id_materi){
        $query = $this->db->prepare("SELECT * FROM teknologiinformasi where id_materi=?");
    ...
    public function update($id_materi,$namaMateri,$kategori,$jenisPembelajaran){
        $query = $this->db->prepare('UPDATE teknologiinformasi set namaMateri=?,kategori=?,jenisPembelajaran=? where id_materi=?');
    ...
    {
        $query = $this->db->prepare("DELETE FROM teknologiinformasi where id_materi=?");
