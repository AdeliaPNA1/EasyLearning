            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" width="60%">
                    ...
                    foreach($data_materi as $row)
                    {
                        ...
                        echo "<td><a class='btn btn-info' href='EditMateri.php?id_materi=".$row['id_materi']."'>Update</a>
                        <a class='btn btn-danger' href='LihatData.php?hapusMateri=".$row['id_materi']."'>Hapus</a></td>";
                        echo "</tr>";
                        $no++;
                    }
                    ?>
