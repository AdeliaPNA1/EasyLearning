  ...
  <div class="container">
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <a href="TambahData7.php" class="btn btn-success">Tambah</a>
                <hr/>
                <table class="table table-bordered" width="60%">
                    ...
                    foreach($data_materi as $row)
                    {
                        ...
                        echo "<td><a class='btn btn-info' href='EditMateri7.php?id_materi=".$row['id_materi']."'>Update</a>
                        <a class='btn btn-danger' href='LihatData7.php?hapusMateri=".$row['id_materi']."'>Hapus</a></td>";
                        echo "</tr>";
                        $no++;
                    }
                    ?>
